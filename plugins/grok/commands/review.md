...
Run a Grok code review through the shared plugin runtime.
...
- `/grok:review` supports working-tree review, branch review, and `--base <ref>`.
- It does not support `--scope staged` or `--scope unstaged`.
- Optional focus text after the flags narrows the review. For a review that challenges the design itself, use `/grok:adversarial-review`.
- `--model` and `--effort` are runtime-selection flags. Leave them unset unless the user asked for a specific model or reasoning effort.
